...
import com.doxa.oauth2.exceptions.TokenServiceException;
...
import com.doxa.oauth2.repositories.token.JsonWebTokenRepository;
import com.doxa.oauth2.repositories.token.OpaqueTokenRepository;
...
//            String nonce,
            Set<String> scopes, Duration idTokenLifetime) {
...
//                            nonce,
    ...
    public JsonWebToken createPersonalizedJwtAccessToken(
            User user, String clientId,
//            String nonce,
            Set<String> scopes, Duration accessTokenLifetime) {
...
//            return jsonWebTokenRepository.save(jsonWebToken);
    ...
    public OpaqueToken createPersonalizedOpaqueAccessToken(
        ...
        opaqueToken.setSubject(user.getId());
