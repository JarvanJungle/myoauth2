...
import com.doxa.oauth2.serviceImpl.AuthorizationCodeService;
...
public class AuthorizationController {
    ...
    public String authorizationRequest(
        ...
        if (registeredClient.isEmpty()) {
            ...
            if (!client.getGrantTypes().contains(GrantType.AUTHORIZATION_CODE.toString())) {
                return redirectError(
                        redirectUri,
                        "unauthorized_client",
        ...
        LOG.info(
                ...
                endUserDetails.getId(), // TODO: update indentifier
                clientId,
                scopes);
        ...
        AuthorizationCode authorizationCode =
                authorizationCodeService.createAndStoreAuthorizationState(
                        ...
                        redirectUri,
                        scopes,
                        endUserDetails.getId() != null ? endUserDetails.getId(): "",
                        nonce,
                        code_challenge,
                        code_challenge_method);
        Authentication auth = SecurityContextHolder.getContext().getAuthentication();
        // Remove session after login to avoid logout issue
